...
#baglabels<-baglabels[baglabels$Parameter=="Diss TPO4 (in H2SO4)FILTRD"|baglabels$Parameter=="Chl A, Vol Filtered:____________"|
#  baglabels$Parameter=="DOC (in H2SO4)FILTERED",]
baglabels<-baglabels[baglabels$basingrouping=="Oneida"|baglabels$basingrouping=="parks",]
