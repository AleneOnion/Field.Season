...
labels<-labels[labels$type=="Sample2",]
labels<-labels[labels$basingrouping=="Lower Hudson",]
#labels<-labels[labels$Parameter=="TOC (in H2SO4)",]
#labels<-labels[labels$basingrouping=="QA",]
#labels<-labels[labels$Lake=="Round Pond",]
#labels<-labels[labels$sample=="19SUS096",]
#labels<-labels[labels$Lake=="Equipment Blank epi"|labels$Lake=="Equipment Blank hypo",]
#####################################################################################################################
#####################################################################################################################
#####################################################################################################################
#####################################################################################################################
