...
#labels<-labels[labels$Parameter=="Diss TPO4 (in H2SO4)FILTRD"|labels$Parameter=="Chl A, Vol Filtered:____________"|labels$Parameter=="DOC (in H2SO4)FILTERED",]
labels<-labels[labels$basingrouping=="Oneida"|labels$basingrouping=="parks",]
labels<-labels[order(labels$type,labels$sample,labels$Parameter),]
```
